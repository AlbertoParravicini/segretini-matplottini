...
def barplot(res: pd.DataFrame) -> plt.Figure:
    ...
    palettes = [[COLORS["r1"], COLORS["bb0"], COLORS["bb2"], COLORS["bb3"], COLORS["bb4"], COLORS["bb5"]]] * num_col * num_row
    ...
    for i, group in enumerate(groups):
        ...
        ax.annotate(f"{cpu_label} ms", xy=(0.5, 0.0), fontsize=9, color=COLORS["r4"], ha="center", xycoords="axes fraction", xytext=(0.5, -0.40))
